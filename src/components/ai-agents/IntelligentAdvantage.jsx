  ...
  const advantageItems = [
    {
      ...
      icon: (
        <svg className="w-6 h-6 text-[#1746D2]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
        </svg>
      ),
      bgClass: "bg-blue-50",
      accentText: "text-[#1746D2]",
      isBlue: true
    },
    {
              ...
              >
                <div className={`relative w-full h-full duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]`}>
                  ...
                  <div className={`absolute inset-0 w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)] p-8 rounded-3xl text-white flex flex-col justify-center shadow-xl transition-all duration-300 ${
                    ...
                    <p className="font-body text-sm text-white/95 leading-relaxed font-medium">
                      {item.delivery}
                    </p>
                  </div>
