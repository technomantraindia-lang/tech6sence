      ...
      <div className="mx-auto max-w-[1400px] px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 relative z-10">
          {options.map((opt, i) => (
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#1746D2]/10 to-white rounded-bl-full pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-6">
                  <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center border border-slate-100 group-hover:bg-[#1746D2]/10 transition-colors">
                  ...
                  <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center group-hover:border-[#1746D2]/40 group-hover:bg-[#1746D2] transition-all duration-300">
                ...
                <h3 className="font-display text-xl font-bold text-slate-900 mb-3 group-hover:text-[#1746D2] transition-colors">
                  {opt.title}
                </h3>
