      ...
      <div className="relative z-10 mx-auto max-w-[85rem] px-6 text-center">
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ease-out ${
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <Link to="/ai-agents" className="w-full sm:w-auto group inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full border-2 border-slate-200 font-body text-sm font-bold text-slate-700 bg-white hover:border-violet-200 hover:bg-violet-50 hover:text-violet-700 transition-all">
