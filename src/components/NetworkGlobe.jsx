...
export default function NetworkGlobe({ progress }) {
  ...
  const globeOpacity = Math.min(Math.max((progress - 0.15) * 2.5, 0), 1);
    ...
    >
      <div className="w-full h-full animate-[spin_30s_linear_infinite]">
        <svg viewBox="0 0 400 400" className="w-full h-full">
          ...
          {/* Core Ambient Glow - Subtler */}
          <circle cx="200" cy="200" r="180" fill="url(#core-glow)" />

          {/* Background grid / sphere rings - Softer strokes */}
          <g stroke="rgba(168,85,247,0.15)" strokeWidth="1" fill="none">
            <circle cx="200" cy="200" r="160" strokeDasharray="2 8" />
            <circle cx="200" cy="200" r="120" stroke="rgba(124,58,237,0.1)" />
            <ellipse cx="200" cy="200" rx="160" ry="40" opacity="0.8" />
            <ellipse cx="200" cy="200" rx="160" ry="100" opacity="0.8" />
            <ellipse cx="200" cy="200" rx="40" ry="160" opacity="0.8" />
            <ellipse cx="200" cy="200" rx="100" ry="160" opacity="0.8" />
          </g>
          ...
          <g stroke="rgba(217,70,239,0.12)" strokeWidth="2.5" fill="none">
          ...
          <g stroke="rgba(217,70,239,0.6)" strokeWidth="1" fill="none">
            <path d="M200 40 L275 80 L330 150 L360 200 L330 250 L275 320 L200 360 L125 320 L70 250 L40 200 L70 150 L125 80 Z" />
            <path d="M200 80 L250 120 L280 200 L250 280 L200 320 L150 280 L120 200 L150 120 Z" />
            <path d="M200 120 L230 160 L230 240 L200 280 L170 240 L170 160 Z" />
            <path d="M40 200 L120 200 M280 200 L360 200" />
          ...
          {/* Active Glowing Nodes - Reduced brightness */}
          {[
            ...
            <g key={i}>
              <circle cx={x} cy={y} r="7" fill="rgba(217,70,239,0.08)" />
              <circle cx={x} cy={y} r="3.5" fill="rgba(217,70,239,0.3)" />
              <circle cx={x} cy={y} r="1.2" fill="rgba(255,255,255,0.9)" />
            </g>
          ))}

          {/* Floating Data Particles - Softer */}
          <g fill="#fff">
            <circle cx="90" cy="110" r="4" fill="rgba(217,70,239,0.15)" />
            <circle cx="90" cy="110" r="1.5" fill="rgba(255,255,255,0.8)" />

            <circle cx="310" cy="100" r="4.5" fill="rgba(217,70,239,0.15)" />
            <circle cx="310" cy="100" r="1.8" fill="rgba(255,255,255,0.8)" />

            <circle cx="290" cy="300" r="3" fill="rgba(217,70,239,0.1)" />
            <circle cx="290" cy="300" r="1.2" fill="rgba(255,255,255,0.8)" />

            <circle cx="110" cy="280" r="4" fill="rgba(217,70,239,0.15)" />
            <circle cx="110" cy="280" r="1.5" fill="rgba(255,255,255,0.8)" />

            <circle cx="160" cy="60" r="3" fill="rgba(217,70,239,0.1)" />
            <circle cx="160" cy="60" r="1.2" fill="rgba(255,255,255,0.8)" />

            <circle cx="240" cy="340" r="4" fill="rgba(217,70,239,0.15)" />
            <circle cx="240" cy="340" r="1.5" fill="rgba(255,255,255,0.8)" />
          </g>
        </svg>
      </div>
    </div>
