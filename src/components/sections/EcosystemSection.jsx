    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[1200px] max-h-[1200px] anim-slow-spin opacity-40 mix-blend-multiply">
          <div className="absolute top-0 right-0 w-[60%] h-[60%] bg-[#1746D2]/30/60 rounded-full blur-[100px]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6">
        ...
        >
          <div className="w-full lg:max-w-4xl">
            ...
            <h2 className="font-display text-[clamp(2.3rem,4.8vw,4.2rem)] leading-[1.08] font-black text-slate-900 tracking-tight">
          ...
          <p className="font-body text-[1.05rem] leading-[1.75] text-slate-500 font-medium lg:max-w-md pt-2">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          >
            {/* Solid white card with subtle inner borders and signature hover shadow */}
            <div className="relative bg-white rounded-[2rem] p-8 md:p-12 shadow-sm hover:shadow-[4px_4px_0px_0px_rgba(23,70,210,0.35)] transition-all duration-300 border border-slate-100 overflow-hidden group h-full flex flex-col">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 rounded-2xl bg-[#1746D2]/10 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 text-[#1746D2]" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84" />
                    </svg>
                  </div>
                ...
                <p className="font-body text-slate-600 mb-8 leading-relaxed w-full text-justify">
                  The Global AI Founder Ecosystem. Visionary Founders is the world's elite most comprehensive premier all-in-one AI Founder Ecosystem designed to transform ambitious entrepreneurs, professionals, start-up founders, consultants, and innovators into owners of globally competitive AI and technology companies. From Idea to International Clients — We don't just simply train founders. We build AI companies with them.
                </p>

                <div className="flex flex-col mb-10 flex-1">
                  {FOUNDERS_POINTS.map((point, i) => (
                    <EcoListItem key={i} index={i} point={point} color="#1746D2" />
                  ))}
                </div>

                <a href="#founders" className="inline-flex items-center justify-center gap-3 w-full py-4 rounded-xl bg-slate-900 text-white font-display font-bold tracking-wide transition-all hover:bg-[#1746D2] hover:shadow-[4px_4px_0px_0px_rgba(23,70,210,0.35)] mt-auto">
          ...
          <div 
            ...
            style={{ opacity: isVisible ? 1 : 0, transform: isVisible ? 'translateY(0)' : 'translateY(40px)' }}
          >
            {/* Emerald themed card with signature hover shadow */}
            <div className="relative bg-white rounded-[2rem] p-8 md:p-12 shadow-sm hover:shadow-[4px_4px_0px_0px_rgba(0,168,107,0.35)] transition-all duration-300 border border-slate-100 overflow-hidden group h-full flex flex-col">
              ...
              <div className="relative z-10">
                ...
                <p className="font-body text-slate-600 mb-8 leading-relaxed w-full text-justify">
                  The World's Most Exclusive Private Global Circle for Elite Investors, Entrepreneurs &amp; Industry Leaders. Stop Networking. Start Unlocking Millions. Welcome to Business Brains — an invitation-only global syndicate reserved for elite investors, visionary entrepreneurs, and titans of industry who operate at the absolute pinnacle of global commerce, capital, and artificial intelligence. Not a community. Not a platform. A Circle — and very few are Admitted. Access is Not Granted. It is Earned.
                </p>
                ...
                <a href="#business-brains" className="inline-flex items-center justify-center gap-3 w-full py-4 rounded-xl bg-slate-900 text-white font-display font-bold tracking-wide transition-all hover:bg-emerald-600 hover:shadow-[4px_4px_0px_0px_rgba(23,70,210,0.35)] mt-auto">
