...
export default function Footer() {
  ...
  return (
    <footer 
      ref={containerRef}
      className="relative w-full overflow-hidden border-t border-slate-100/50"
    >
      {/* Background Video */}
      <video 
        autoPlay 
      ...
      {/* Dark Overlay to ensure the white text remains perfectly readable against bright spots */}
      <div className="absolute inset-0 bg-[#000110]/70 z-0 pointer-events-none"></div>
      ...
      <div className="absolute top-0 inset-x-0 h-[1.5px] bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-500 bg-[size:200%_auto] animate-footer-border z-10" />

      {/* Main Content Area */}
      <div 
        className={`relative z-10 mx-auto max-w-[85rem] px-6 pt-16 pb-12 transition-all duration-1000 ease-out ${
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12">
          ...
          <div className="md:col-span-2 lg:col-span-4 flex flex-col justify-start">
            ...
            <p className="font-body text-[0.88rem] leading-relaxed text-slate-200 mb-6 max-w-sm">
              Transforming vision into intelligence through AI solutions, deep-tech products, and future-ready business ecosystems.
            </p>
            <div className="font-body text-[0.85rem] text-slate-300 space-y-2.5">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:info@tech6senseai.com" className="text-slate-300 hover:text-white transition-colors">
                  info@tech6senseai.com
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                <span className="text-violet-400">📞</span>
                <a href="tel:+919081766355" className="text-slate-300 hover:text-white transition-colors">
                  +91 90817 66355
                </a>
              </div>
            </div>
          ...
          <div className="col-span-1 lg:col-span-2">
            <h4 className="font-display text-sm font-bold text-white tracking-wider uppercase mb-5">
              Company
            </h4>
            <ul className="space-y-3 p-0 m-0 list-none">
              {[
                ...
                <li key={link.label}>
                  <Link 
                    to={link.href}
                    className="font-body text-[0.88rem] text-slate-300 hover:text-white transition-colors relative inline-block group"
                  >
                    {link.label}
      ...
      <div className="relative z-10 w-full bg-[#0A031D] text-slate-400 py-6 px-6 font-body text-[0.82rem]">
        <div className="mx-auto max-w-[85rem] flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Left Side */}
          <div>
            <span>© 2026 TECH6SENSE AI. All rights reserved. | Designed and Developed by <a href="https://technomantra.in/" target="_blank" rel="noreferrer" className="hover:text-violet-400 transition-colors underline underline-offset-4 decoration-violet-500/30">TechnoMantra India</a></span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="text-slate-400 hover:text-violet-400 transition-all duration-300 hover:-translate-y-0.5"
                aria-label="LinkedIn"
              >
