        ...
        >
          ...
          <div
            ...
            style={{
              ...
              background: `radial-gradient(circle 350px at var(--grid-mx, -999px) var(--grid-my, -999px), rgba(139, 92, 246, 0.035), rgba(217, 70, 239, 0.015), transparent 70%)`,
            }}
          />
          ...
          <div className="flex flex-col md:pt-4 z-10 w-full relative">
            ...
            {PROOF_BLOCKS.map((block, i) => (
              ...
              >
                {/* Number Badge */}
                <div className="relative shrink-0 flex items-center justify-center w-10 md:w-11 h-10 md:h-11 rounded-full bg-slate-50 border border-slate-200/60 group-hover:bg-white group-hover:border-violet-300 shadow-sm group-hover:shadow-[0_8px_20px_rgba(139,92,246,0.2)] transition-all duration-300 z-10">
                  {/* Subtle active ping on hover */}
                  <div className="absolute inset-0 rounded-full border border-violet-400 opacity-0 scale-50 group-hover:animate-[ping_1.5s_cubic-bezier(0,0,0.2,1)_infinite] group-hover:opacity-40" />
                  <span className="font-display text-[0.95rem] font-extrabold text-slate-500 group-hover:text-violet-600 transition-colors duration-300 relative z-10">
                    {block.num}
                  </span>
                </div>
                ...
                <div className="flex-1 min-w-0 pt-1.5 md:pt-2">
                  <h4 className="font-display text-[1.2rem] md:text-[1.35rem] font-bold text-slate-800 tracking-tight mb-2 transition-all duration-300 group-hover:text-violet-600 group-hover:translate-x-1">
                    {block.title}
                  </h4>
