...
export default function AIProductOpportunitySection() {
  ...
  return (
    <section className="relative w-full pt-12 pb-24 md:pt-16 md:pb-32 px-6 overflow-hidden bg-[#FAFBFF]">
      {/* Background Decorative Radial Flares - Adjusted for light theme */}
      <div className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 h-[600px] w-[600px] rounded-full bg-gradient-to-tr from-[#1746D2]/10 via-[#00A86B]/5 to-transparent blur-[160px]" />
      <div className="pointer-events-none absolute bottom-10 right-10 h-[400px] w-[400px] rounded-full bg-[#D4AF37]/10 blur-[140px]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1400px]">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          <h2 className="font-display text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
            Start Your Own <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-emerald-600 to-amber-500">AI Product Business</span>
          </h2>
          <p className="font-body text-slate-600 text-base md:text-lg font-medium mb-4">
          ...
          {topHighlights.map((item, idx) => (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="font-display text-xs font-extrabold text-slate-500 tracking-widest px-2 py-0.5 rounded bg-slate-100 border border-slate-200 uppercase">
                  {item.tag}
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
          ...
          <div className="lg:col-span-7 rounded-3xl bg-white border border-slate-200 p-8 sm:p-10 relative overflow-hidden flex flex-col justify-between shadow-lg shadow-slate-200/50">
            ...
            <div>
              ...
              <div className="flex items-center justify-between pb-6 mb-8 border-b border-slate-100">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#00A86B]/10 border border-[#00A86B]/30 text-[#00A86B] shadow-sm">
                    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth="2.5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-display text-2xl font-black text-slate-900 tracking-tight">What We Provide</h3>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-50/80 -mx-8 -mb-8 p-6 sm:px-8">
          ...
          <div className="lg:col-span-5 rounded-3xl bg-white border border-slate-200 p-8 sm:p-10 relative overflow-hidden flex flex-col justify-between shadow-lg shadow-slate-200/50">
            ...
            <div>
              ...
              <div className="flex items-center justify-between pb-6 mb-8 border-b border-slate-100">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#1746D2]/10 border border-[#1746D2]/30 text-[#1746D2] shadow-sm">
                    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth="2.5">
                  ...
                  <div>
                    <h3 className="font-display text-2xl font-black text-slate-900 tracking-tight">Ideal For</h3>
            ...
            <div className="mt-8 p-5 rounded-2xl bg-gradient-to-r from-[#1746D2]/10 to-[#00A86B]/10 border border-slate-200 text-center">
              <p className="font-display text-xs font-bold text-slate-700 uppercase tracking-wide">
        ...
        {/* Global CTA Section */}
        <div className="flex flex-col items-center justify-center text-center p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-[#1746D2] via-[#00A86B] to-[#D4AF37] shadow-xl relative overflow-hidden">
          {/* Optional: adding a subtle overlay to make text pop more against the gradient */}
          <div className="absolute inset-0 bg-black/10 pointer-events-none" />

          <h3 className="font-display text-2xl sm:text-3xl font-extrabold text-white mb-3 relative z-10">
            Ready to Launch Your Proprietary AI Product Brand?
          </h3>
          <p className="font-body text-white/90 text-sm sm:text-base max-w-2xl mb-8 leading-relaxed relative z-10">
