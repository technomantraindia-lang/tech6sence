...
export default function SixDimensions() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full py-20 lg:py-32 bg-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#1746D2]/10/50 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/4 pointer-events-none" />
      ...
      <div className="mx-auto max-w-[1400px] px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-[clamp(2rem,4vw,3.5rem)] leading-tight font-extrabold tracking-tight text-slate-900 mb-6">
            The Six Dimensions Behind <span className="bg-gradient-to-r from-[#1746D2] to-[#00A86B] bg-clip-text text-transparent">TECH6SENSE AI</span>
          </h2>
        ...
        <div className="hidden lg:block relative w-full max-w-[1000px] h-[700px] mx-auto mt-20">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#1746D2]/10/40 to-fuchsia-100/40 rounded-full blur-md animate-pulse" />
            <div className="absolute inset-0 rounded-full border border-[#1746D2]/10/50 m-2" />
            <span className="font-display font-extrabold text-xl text-slate-900 mb-1.5 relative z-10">TECH6SENSE AI</span>
            <span className="font-body text-[9px] uppercase font-bold text-[#1746D2] tracking-widest relative z-10">One Ecosystem</span>
          </div>
          ...
          {dimensions.map((d, i) => (
            <div 
              key={`node-${i}`}
              className={`absolute w-[240px] p-5 rounded-2xl bg-white border border-slate-100 shadow-sm transition-all duration-700 ease-out hover:border-[#1746D2]/40 hover:shadow-[4px_4px_0px_0px_rgba(23,70,210,0.35)] hover:-translate-y-1 cursor-default flex flex-col z-10 ${
                d.cls
              } ${
            ...
            >
              <div className="w-10 h-10 rounded-full bg-[#1746D2]/10 flex items-center justify-center mb-3">
                <div className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-[#1746D2] to-[#00A86B]" />
              </div>
        ...
        <div className="lg:hidden mt-16 flex flex-col items-center relative">
          ...
          >
            ...
            <span className="font-body text-[8px] uppercase font-bold text-[#1746D2] tracking-widest relative z-10">One Ecosystem</span>
          </div>
            ...
            {dimensions.map((d, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 shrink-0 rounded-full bg-[#1746D2]/10 flex items-center justify-center">
                    <div className="w-2 h-2 rounded-full bg-gradient-to-r from-[#1746D2] to-[#00A86B]" />
                  </div>
