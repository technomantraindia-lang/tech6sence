...
export default function GlobalPresence() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full py-20 md:py-32 bg-white overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-[#1746D2]/10/60 rounded-full blur-[100px] -translate-y-1/2 -translate-x-1/4 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-display text-[clamp(2.5rem,4vw,3.5rem)] leading-tight font-extrabold tracking-tight text-slate-900 mb-6 max-w-lg">
              Built for <span className="bg-gradient-to-r from-[#1746D2] to-[#00A86B] bg-clip-text text-transparent">Global Impact.</span><br />
            ...
            <div className="flex flex-wrap gap-3">
              {points.map((point, index) => (
                <div 
                  key={index}
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200 transition-all duration-700 ease-out hover:border-[#1746D2]/40 hover:bg-[#1746D2]/10/50 ${
                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
                  }`}
                  style={{ transitionDelay: `${400 + index * 100}ms` }}
                >
                  <svg className="w-3.5 h-3.5 text-[#1746D2]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            ...
            <div className="relative w-full h-[90%] md:h-[95%] max-w-[480px] p-6 md:p-8 rounded-3xl border border-slate-200 bg-slate-50/50 backdrop-blur-md shadow-xl flex flex-col justify-between overflow-hidden">
              ...
              <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-[#1746D2] via-fuchsia-500 to-[#1746D2]" />
              ...
              <div className="border-b border-slate-100 pb-4 mb-4">
                <span className="text-[10px] font-bold text-[#1746D2] uppercase tracking-widest font-mono">Operations Command</span>
              ...
              <div className="relative flex-grow flex items-center justify-center my-4 h-[180px] md:h-[220px]">
                ...
                <div className="absolute w-40 h-40 rounded-full border border-dashed border-[#1746D2]/20 flex items-center justify-center">
                  <div className="w-24 h-24 rounded-full border border-dashed border-[#1746D2]/20/50 flex items-center justify-center">
                    <div className="w-12 h-12 rounded-full border border-[#1746D2]/20/30 flex items-center justify-center" />
                  </div>
                </div>
                ...
                <div className="absolute top-[35%] left-[25%] w-2 h-2 rounded-full bg-[#1746D2] shadow-[0_0_8px_#7c3aed] animate-ping" />
                <div className="absolute top-[20%] right-[30%] w-2 h-2 rounded-full bg-[#00A86B] shadow-[0_0_8px_#d946ef] animate-pulse" />
                <div className="absolute bottom-[25%] right-[20%] w-2.5 h-2.5 rounded-full bg-[#1746D2] shadow-[0_0_10px_#7c3aed] animate-ping" />
              ...
              <div className="space-y-3 font-mono text-[11px] text-slate-600">
                ...
                {/* Node 1: NA Hub */}
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-white border border-slate-100 hover:border-[#1746D2]/10 transition-colors shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    <span>Ping: <span className="text-[#1746D2] font-bold">14ms</span></span>
                    <span className="w-12 bg-slate-100 h-1 rounded-full overflow-hidden inline-block">
                      <span className="block bg-[#1746D2] h-full w-[45%]" />
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-white border border-slate-100 hover:border-fuchsia-100 transition-colors shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    <span>Ping: <span className="text-[#00A86B] font-bold">32ms</span></span>
                    <span className="w-12 bg-slate-100 h-1 rounded-full overflow-hidden inline-block">
                      <span className="block bg-[#00A86B] h-full w-[60%]" />
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-white border border-slate-100 hover:border-[#1746D2]/10 transition-colors shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    <span>Ping: <span className="text-[#1746D2] font-bold">48ms</span></span>
                    <span className="w-12 bg-slate-100 h-1 rounded-full overflow-hidden inline-block">
                      <span className="block bg-[#1746D2] h-full w-[35%]" />
                    </span>
                  </div>
                </div>

                {/* Node 4: IndiaHQ */}
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-gradient-to-r from-[#1746D2]/10 to-fuchsia-50/20 border border-[#1746D2]/20 shadow-sm">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-[#1746D2] to-[#00A86B] animate-pulse" />
                    <span className="font-bold text-slate-900">HQ::CENTRAL</span>
                    <span className="text-[9px] text-[#1746D2] font-bold">Core Node</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-slate-900">Ping: <span className="font-bold">4ms</span></span>
                    <span className="w-12 bg-[#1746D2]/20 h-1 rounded-full overflow-hidden inline-block">
                      <span className="block bg-gradient-to-r from-[#1746D2] to-[#00A86B] h-full w-[85%]" />
                    </span>
                  </div>
                </div>
