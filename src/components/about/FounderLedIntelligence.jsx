...
export default function FounderLedIntelligence() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full py-20 lg:py-32 bg-slate-50 overflow-hidden">
      ...
      <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-[#1746D2]/10/50 rounded-full blur-[120px] translate-x-1/3 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative w-full aspect-[4/5] max-w-md mx-auto lg:mx-0 rounded-3xl border border-slate-200 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.05)] overflow-hidden group">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="relative w-[85%] h-[90%] rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col items-center justify-center bg-white/50">
                  <img 
                    src={founderImg} 
                    alt="Dr. Chintan Patel" 
              ...
              <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-[#1746D2]/40/30 rounded-tl-3xl m-4" />
              <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-[#1746D2]/40/30 rounded-br-3xl m-4" />
            </div>
          </div>
          ...
          >
            ...
            <h2 className="font-display text-[clamp(2rem,4vw,3.5rem)] leading-[1.1] font-extrabold tracking-tight text-slate-900 mb-6">
              Led by Deep <span className="bg-gradient-to-r from-[#1746D2] to-[#00A86B] bg-clip-text text-transparent">AI Expertise</span>
            </h2>
