...
export default function MembershipPrivilege() {
  ...
  return (
    <section className="relative bg-[#000110] text-white py-24 md:py-32 border-b border-slate-800/80 overflow-hidden">
      ...
      {/* Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-r from-emerald-900/15 to-[#0b1329]/15 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div 
            className="inline-block px-6 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 font-mono text-xs sm:text-sm font-bold text-emerald-300 mb-8 uppercase tracking-widest"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {points.map((pt, idx) => (
              ...
              >
                <div className="font-mono text-xs text-emerald-400 font-bold mb-3">0{idx + 1}</div>
                <h3 
