...
export default function SyndicatePrivileges() {
  ...
  return (
    <section id="privilege" className="relative bg-slate-50 text-slate-900 py-20 md:py-28 border-b border-slate-200 overflow-hidden">
          ...
          {privileges.map((priv, idx) => (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 group-hover:bg-white/20 border border-slate-200 text-[11px] font-mono font-bold text-slate-800 group-hover:text-white transition-colors">
                  <svg className="w-3.5 h-3.5 text-[#1746D2] group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                ...
                <p className="text-slate-600 group-hover:text-white text-sm leading-relaxed font-normal text-justify md:text-left transition-colors">
                  {priv.desc}
                </p>
              </div>
            </div>
