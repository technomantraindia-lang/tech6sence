      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {privileges.map((priv, idx) => (
            <div 
              key={idx}
              className="p-8 rounded-3xl bg-slate-50 border border-slate-200 hover:border-emerald-500/40 transition-all duration-300 shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:shadow-md relative overflow-hidden group flex flex-col justify-between"
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100/70 border border-emerald-200 text-[11px] font-mono font-bold text-emerald-800">
