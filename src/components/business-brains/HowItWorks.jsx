          ...
          <div className="space-y-10 relative">
            ...
            {steps.map((step, idx) => (
              <div key={idx} className="relative flex items-start gap-6 group">
                {/* Icon Circle */}
                <div className="relative z-10 flex-shrink-0 w-12 h-12 rounded-full bg-slate-50 border-2 border-cyan-100 flex items-center justify-center group-hover:border-cyan-500 group-hover:bg-cyan-50 transition-colors duration-300">
                  {step.icon}
                </div>
