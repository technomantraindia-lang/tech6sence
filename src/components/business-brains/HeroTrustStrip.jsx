...
export default function HeroTrustStrip() {
  return (
    <>
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[750px] bg-emerald-900/15 rounded-full blur-[180px] pointer-events-none z-0" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10 w-full my-auto py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-left">
          ...
          <div className="lg:col-span-7 flex flex-col items-start gap-5">
            {/* Minimal Eyebrow Tag */}
            <div className="font-mono text-xs font-bold text-emerald-400 uppercase tracking-[0.25em]">
              BUSINESS BRAINS Powered by TECH6SENSE AI
            </div>

            {/* Above the Fold Title & Main Headline */}
            <div className="space-y-2">
              <h2 className="text-lg sm:text-xl font-bold text-emerald-300/90 font-mono uppercase tracking-wider">
            ...
            >
              ...
              <p>
                BUSINESS BRAINS is not designed for networking. It is built for <strong className="text-emerald-300 font-bold">influence, collaboration, investment, innovation, and legacy</strong>. Within this private circle, relationships become strategic alliances, conversations become global ventures.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mt-2">
              <a 
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-400 hover:to-blue-500 text-white rounded-full font-bold text-sm tracking-wide transition-all duration-300 shadow-[0_0_25px_rgba(0, 168, 107,0.35)] hover:-translate-y-0.5 cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 w-full">
            ...
            <div className="relative inline-block mx-auto lg:mx-0 group w-fit">
              <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/30 to-[#1746D2]/30 rounded-2xl blur-lg opacity-50 group-hover:opacity-80 transition-opacity" />
            ...
            <div className="p-6 md:p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md shadow-2xl relative overflow-hidden flex flex-col gap-5">
              <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 rounded-bl-full blur-xl pointer-events-none" />
              
              <div className="text-xs md:text-sm font-mono text-emerald-300/90 uppercase tracking-widest space-y-3.5 border-b border-white/10 pb-5">
    ...
    <div className="w-full bg-[#050615] border-y border-white/5 py-8 relative z-10">
      <div className="max-w-5xl mx-auto px-6 w-full">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center divide-x-0 md:divide-x divide-white/10">
          ...
          <div className="px-2">
            <div className="text-xl md:text-2xl font-bold font-mono text-emerald-400">500+</div>
            <div className="text-xs text-slate-350 font-medium">Members Worldwide</div>
          </div>

          <div className="px-2">
            <div className="text-xl md:text-2xl font-bold font-mono text-emerald-400">9+</div>
            <div className="text-xs text-slate-350 font-medium">Nations</div>
          </div>

          <div className="px-2">
            <div className="text-xl md:text-2xl font-bold font-mono text-emerald-400">Invitation Only</div>
            <div className="text-xs text-slate-350 font-medium">By Invitation Only</div>
          </div>

          <div className="px-2">
            <div className="text-xl md:text-2xl font-bold font-mono text-emerald-400">TECH6SENSE AI</div>
