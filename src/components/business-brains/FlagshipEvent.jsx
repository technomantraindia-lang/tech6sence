  ...
  return (
    <section className="relative bg-[#000110] text-white py-16 md:py-20 overflow-hidden border-b border-slate-800/80">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-tr from-emerald-900/20 to-[#0b1329]/20 rounded-full blur-[140px] pointer-events-none" />
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* Trophy Badge */}
          <div className="w-14 h-14 rounded-full bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center mb-5 shadow-[0_0_25px_rgba(0, 168, 107,0.25)]">
            <svg className="w-7 h-7 text-emerald-400" fill="currentColor" viewBox="0 0 576 512">
