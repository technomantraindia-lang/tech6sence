      ...
      <div className="relative mx-auto max-w-[85rem] px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className={`transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            ...
            <div className="font-body text-slate-600 text-base md:text-lg leading-relaxed mb-10 max-w-xl space-y-4">
              <p className="font-bold text-slate-900 text-lg">AI Solutions Built for Every Industry</p>
              <p>AI is no longer an experimental technology. It has become the competitive advantage separating market leaders from everyone else.</p>
              <p>Every industry faces unique operational challenges—from rising costs and labor shortages to inefficient workflows, customer experience gaps, cybersecurity threats, and increasing competition.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-12">
              ...
              <Link to="#discuss" className="group inline-flex items-center gap-2 px-8 py-3.5 rounded-full border-2 border-slate-200 font-body text-sm font-bold text-slate-700 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 transition-all">
          ...
          <div className={`relative h-[450px] lg:h-[600px] w-full flex items-center justify-center transition-all duration-1000 delay-300 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            ...
            <div className="relative w-full max-w-[500px] aspect-square animate-float">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-white rounded-full shadow-[0_20px_50px_rgba(15,23,42,0.1)] border border-slate-100 flex items-center justify-center z-20">
                <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-blue-100 to-emerald-50 flex items-center justify-center relative">
              ...
              <svg className="absolute inset-0 w-full h-full text-slate-200 z-0" viewBox="0 0 500 500">
                ...
                {/* Radiating Lines */}
                <path d="M250,250 L100,100" stroke="url(#blue-gradient-ind)" strokeWidth="1.5" />
                <path d="M250,250 L400,100" stroke="url(#blue-gradient-ind)" strokeWidth="1.5" />
                <path d="M250,250 L50,250" stroke="url(#blue-gradient-ind)" strokeWidth="1.5" />
                <path d="M250,250 L450,250" stroke="url(#blue-gradient-ind)" strokeWidth="1.5" />
                <path d="M250,250 L100,400" stroke="url(#blue-gradient-ind)" strokeWidth="1.5" />
                <path d="M250,250 L400,400" stroke="url(#blue-gradient-ind)" strokeWidth="1.5" />
                
                <defs>
                  <linearGradient id="blue-gradient-ind" x1="0%" y1="0%" x2="100%" y2="100%">
